...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        Color c1 = new Color(242,242,222);
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Organization Admin Manage Panel");
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
       try
       {
        ...
        popOrganizationUserAccountTable();
        JOptionPane.showMessageDialog(null, "Successfully created User Account", "success",JOptionPane.PLAIN_MESSAGE);
        resetFields();
       }
       catch(Exception e)
       {
