...
public class ManageEmployeeJPanel extends javax.swing.JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        Color c1 = new Color(201,245,245);
    ...
    public void populateOrganizationEmpComboBox(){
        ...
        for(Organization organization : organizationDir.getOrganizationList()){
            ...
            if(!(organization.getName().equals("Volunteer Organization")) && 
                    ...
                    !(organization.getName().equals("Patients Organization")))
            {
    ...
    private void populateEmployeeAndPeopleTable(Organization organization){
       ...
       if (organization.getName().equals("Patients Organization"))
        {
           for(Patients person : organization.getPersonDirectory().getPatientsList()){
            Object[] row = new Object[2];
            row[0] = person.getPatientsId();
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(201, 245, 245));
        ...
        manageOrg.setText("Organization Employee Manage Panel");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(66, 66, 66)
                .addComponent(manageOrg, javax.swing.GroupLayout.PREFERRED_SIZE, 442, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Successfully created Employee", "success",JOptionPane.PLAIN_MESSAGE);
        resetFields();
        }
        catch(Exception e)
        {
