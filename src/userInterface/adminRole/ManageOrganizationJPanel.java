...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    public void populateOrganizationComboBox()
    {
      ...
      organizationJComboBox.removeAllItems();
            ...
            else if(enterprise.getEnterpriseType().getValue().equals(EnterpriseType.Relief.getValue()))
            {
             organizationJComboBox.addItem(Type.Patients);  
             organizationJComboBox.addItem(Type.Controller); 
            }
            else if(enterprise.getEnterpriseType().getValue().equals(EnterpriseType.WHO.getValue()))
            {
             organizationJComboBox.addItem(Type.WHOStaff);  //
            }
            else if(enterprise.getEnterpriseType().getValue().equals(EnterpriseType.Community.getValue()))
            {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("         Organization Manage Panel");
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        if(type == null)
        {
       JOptionPane.showMessageDialog(this, "Select a organization!", "warning",JOptionPane.PLAIN_MESSAGE);
        return;     
        }
