...
public class ViewMyProfile extends javax.swing.JPanel {
    ...
    public ViewMyProfile(JPanel userProcessContainer, UserAccount account) {
      ...
      if(person.getDob()!=null && person.getAddressline1()!=null && person.getTown()!=null 
                ...
                )
       {
        ...
        addressField.setText(person.getAddressline1());
            ...
            zipCodeField.getText()!=null && !zipCodeField.getText().trim().isEmpty() )
        {
            try
            {
              ...
              Date dateOfBirthVal  = dateFormat.parse(donorDobField.getText()) ;
                ...
                if(age<=0 )
                {
                    JOptionPane.showMessageDialog(null, "VALID age required!","warning", JOptionPane.WARNING_MESSAGE);
                    return;
                }
                if((phoneNumberField.getText()).length()<10)
                {  
                    JOptionPane.showMessageDialog(null, "VALID phone number required!","warning", JOptionPane.WARNING_MESSAGE);
                    return;
                }
            ...
            catch(ParseException pe)
            {
                ...
                JOptionPane.showMessageDialog(null, "Successfully updated the profile", "success", JOptionPane.PLAIN_MESSAGE);
