 ...
 * @author shivanisahu
 */
public class SendVitalSignInfoToDoctorPanel extends javax.swing.JPanel {
     ...
     */
    public SendVitalSignInfoToDoctorPanel(JPanel userProcessContainer, UserAccount userAccount, EcoSystem ecoSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        sendInfoTodctrBtn = new javax.swing.JButton();
        ...
        sendInfoTodctrBtn.setText("Send Vital Signs");
        sendInfoTodctrBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sendInfoTodctrBtnActionPerformed(evt);
            }
        });
        ...
        sendToDoctorPanel.setLayer(sendInfoTodctrBtn, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        sendToDoctorPanelLayout.setHorizontalGroup(
            ...
            .addGroup(sendToDoctorPanelLayout.createSequentialGroup()
                ...
                .addGroup(sendToDoctorPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(sendInfoTodctrBtn)
    ...
    private void sendToDoctNoRadioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendToDoctNoRadioActionPerformed
        ...
        person.setSendInfoToDoctor(false);
    ...
    private void sendToDoctorYesRadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendToDoctorYesRadActionPerformed
        ...
        person.setSendInfoToDoctor(true);

    }//GEN-LAST:event_sendToDoctorYesRadActionPerformed

    private void sendInfoTodctrBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendInfoTodctrBtnActionPerformed

        try
        {
            if(sendToDoctorGroup.getSelection() == null)
            {
                JOptionPane.showMessageDialog(null, "Select a radio button to send vital Sign data to doctor ","warning", JOptionPane.WARNING_MESSAGE);
                return;
            }
            if(sendToDoctorYesRad.isSelected())
            {
                ...
                {
                    JOptionPane.showMessageDialog(null, "Enter prescription field less than 100 characters ","warning", JOptionPane.WARNING_MESSAGE);
                    return;
                }
                ...
                SendInfoToDoctorWorkRequest sendInfoToDoctorWorkRequest = new SendInfoToDoctorWorkRequest();
                sendInfoToDoctorWorkRequest.setMessage("Vital Sign Information");
                sendInfoToDoctorWorkRequest.setSender(userAccount);
                sendInfoToDoctorWorkRequest.setStatus("Sent");
                sendInfoToDoctorWorkRequest.setMedication(medicatnTxt);
                sendInfoToDoctorWorkRequest.setRequestDate(new Date());
                sendInfoToDoctorWorkRequest.setReceiver(docAccount);
               
                docAccount.getWorkQueue().getWorkRequestList().add(sendInfoToDoctorWorkRequest);
                userAccount.getWorkQueue().getWorkRequestList().add(sendInfoToDoctorWorkRequest);
                JOptionPane.showMessageDialog(null, "Information has been sent successfully", "success", JOptionPane.PLAIN_MESSAGE);
                currentMedicationsTxtArea.setText("");
            }
            else if(sendToDoctNoRadio.isSelected())
            {
                person.setSendInfoToDoctor(false);
                JOptionPane.showMessageDialog(null, "Thank You, Information will not be shared with doctor", "success", JOptionPane.PLAIN_MESSAGE);

            }
        }
        catch(Exception e)
        {
            JOptionPane.showMessageDialog(null, "Please Enter valid details in all fields ","warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
    }//GEN-LAST:event_sendInfoTodctrBtnActionPerformed
    ...
    public void populateDoctorComboBx()
    {
       ...
       if(doctorOrganization!=null)
       {
        ...
        {
        JOptionPane.showMessageDialog(null, "No doctors exists!","warning", JOptionPane.WARNING_MESSAGE);
         return;    
        }
         doctorComboBx.removeAllItems();
    ...
    private javax.swing.JButton sendInfoTodctrBtn;
