 ...
 */
public class ReliefEnterpriseManagerWorkArea extends javax.swing.JPanel {
   ...
   private VolunteerOrganization vo;
    ...
    private PatientsOrganization hsOrg;
    ...
    public ReliefEnterpriseManagerWorkArea(JPanel userProcessContainer, Enterprise enterprise, EcoSystem ecoSystem, UserAccount userAccount) {
        initComponents();
    ...
    protected void paintComponent(Graphics g) {
        ...
        Color c1 = new Color(229,194,229);
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(229, 194, 229));
        ...
        manageEnt1.setText("          Relief  Enterprise Manager Panel");
        ...
        top3VolunteersBtn.setText("View Top Helpers");
        ...
        totalHelpReq.setText("Total Help Service Requests");

        totSenDevReq.setFont(new java.awt.Font("Malayalam MN", 3, 18)); // NOI18N
        totSenDevReq.setText("Total Device Requests");
        ...
        totSenDevReqField.setBackground(new java.awt.Color(236, 209, 181));

        totTransReqField.setEditable(false);
        totTransReqField.setBackground(new java.awt.Color(236, 209, 181));

        totHelpReqField.setEditable(false);
        totHelpReqField.setBackground(new java.awt.Color(236, 209, 181));

        findTop3Donors.setText("View Top Contributors");
        ...
        totSenDevReq1.setText("Total Amount Funded");

        donatedAmntField.setEditable(false);
        donatedAmntField.setBackground(new java.awt.Color(236, 209, 181));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(top3VolunteersBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(41, 41, 41)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(268, 268, 268)
                        .addComponent(manageEnt1, javax.swing.GroupLayout.PREFERRED_SIZE, 518, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(133, 133, 133)
                        .addComponent(viewDetailedReportBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    public void populatePieChartData()
    {
       ...
       for(Organization organization : enterprise.getOrganizationDirectory().getOrganizationList())
       {
          ...
          {
          this.hsOrg = (PatientsOrganization)organization;   
           totalPatientss = organization.getPersonDirectory().getPatientsList().size();
          }
       }
       try
       {
       ...
       if(vo!=null)
       {
        ...
        totalDrivers = transOrg.getPersonDirectory().getPersonList().size();
         ...
         dataSet.setValue("Total No of Patients",totalPatientss);
     ...
     for(UserAccount volunteerAccount : vo.getUserAccountDirectory().getUserAccountList())
      {
        if(!volunteerAccount.getWorkQueue().getWorkRequestList().isEmpty())
       {
         for(WorkRequest request : volunteerAccount.getWorkQueue().getWorkRequestList() )
         {
          ...
          if(nhwr.getRequestResult().equalsIgnoreCase(ControllerWorkRequest.REQUEST_ACCEPT))
          {
          ++noOfRequests;    
          }
          }
        ...
        for(WorkRequest wrkrequest : donorAccount.getWorkQueue().getWorkRequestList() )
         {  
           ...
           if(wrkrequest.getMessage().equalsIgnoreCase("Need Sensor Device"))
           {
               ...
               if(nsdwr.getdonationRequestResult().equalsIgnoreCase(ControllerWorkRequest.REQUEST_ACCEPT))
               {
               ++noOfRequests; 
               }
           }
