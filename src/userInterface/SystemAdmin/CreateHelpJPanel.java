...
public class CreateHelpJPanel extends javax.swing.JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        Color c1 = new Color(181,218,204);
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(181, 218, 204));

        manageEnt2.setFont(new java.awt.Font("Malayalam MN", 3, 24)); // NOI18N
        manageEnt2.setText("RELIEF");
        ...
        helpName.setText("Assistance is provided for:");

        createHelpJButton.setBackground(new java.awt.Color(209, 209, 220));
        createHelpJButton.setText("Assist");
        ...
        helpType.setText("Type of assistance:");

        manageEnt1.setFont(new java.awt.Font("Malayalam MN", 3, 24)); // NOI18N
        manageEnt1.setText("   Assistance");

        cancelBtn.setBackground(new java.awt.Color(209, 209, 220));
    ...
    private void createHelpJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createHelpJButtonActionPerformed
       ...
       {
            JOptionPane.showMessageDialog(this, "Please filli the details", "warning", JOptionPane.WARNING_MESSAGE);
            return;   
       }
        ...
        JOptionPane.showMessageDialog(this, "Created successfully", "success", JOptionPane.PLAIN_MESSAGE);
