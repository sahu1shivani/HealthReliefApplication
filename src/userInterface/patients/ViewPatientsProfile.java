 ...
 * @author anuja
 */
public class ViewPatientsProfile extends javax.swing.JPanel {
      private JPanel userProcessContainer;
    private UserAccount userAccount; 
    private Person person;
 
    /**
     * Creates new form ViewPatientsProfile
     */
    public ViewPatientsProfile(JPanel userProcessContainer, UserAccount userAccount) {
        initComponents();
    ...
    public void populateFields()
    {
        ...
        {
       JOptionPane.showMessageDialog(null, "Patients Profile has not been updated!", "warning", JOptionPane.WARNING_MESSAGE);
         return;      
        }
    }
    /**
    ...
    private void initComponents() {
        ...
        manageEnt1.setText("View Patients Profile Panel");
