 ...
 * @author anuja
 */
public class UpdatePatientsProfile extends javax.swing.JPanel {
     ...
     */
    public UpdatePatientsProfile(JPanel userProcessContainer, UserAccount userAccount, UserAccountDirectory userAccountDirectory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        manageEnt1.setText("        Update Patients Profile");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(257, 257, 257)
                        .addComponent(manageEnt1, javax.swing.GroupLayout.PREFERRED_SIZE, 335, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(277, 277, 277)
    ...
    private void saveJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveJButtonActionPerformed
             ...
             zipCodeField.getText()!=null && !zipCodeField.getText().isEmpty())
        {
                 ...
                 if(!(userAccount.getUserName().equals(userNameTxtField.getText()))&&!(userAccountDirectory.checkIfUsernameIsUnique(userNameTxtField.getText())))
                  ...
                  int age = Validation.calculateTheAge(dateOfBirthVal);
                   if(age<12)
                    ...
                    person.setAddressline2(addressField2.getText());
                    person.setAddressline1(addressField1.getText());
            ...
            return; 
             ...
             JOptionPane.showMessageDialog(null, "Successfully upated profile", "success", JOptionPane.PLAIN_MESSAGE);
