...
public class GetHelpFromVolunteerJPanel extends javax.swing.JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        Color c1 = new Color(255,204,103);
    ...
    private void initComponents() {
        ...
        helpDetails.setText(" Enter details about the service required.");
        ...
        manageEnt1.setText("Required service :");

        manageEnt5.setFont(new java.awt.Font("Malayalam MN", 3, 24)); // NOI18N
        manageEnt5.setText("Request service from Anonymous Person");

        manageEnt3.setFont(new java.awt.Font("Malayalam MN", 3, 24)); // NOI18N
        manageEnt3.setText("Service Requests Details");
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Request ID", "Service Recieved", "Requested Date", "Helper Name", "Status"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(manageEnt5, javax.swing.GroupLayout.PREFERRED_SIZE, 510, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void createRequestButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createRequestButtonActionPerformed
       ...
       try
        ...
        {
         JOptionPane.showMessageDialog(null, "Enter comments", "warning",JOptionPane.WARNING_MESSAGE);
         return;
        }
       ...
       Organization org = null;
        for(Network network : ecoSystem.getNetworkList())
        {
         ...
         {
          if(e.getEnterpriseType().equals(Enterprise.EnterpriseType.Community))
          {
        ...
        if (org!=null){
         ...
         JOptionPane.showMessageDialog(null, "Request successfully created", "success", JOptionPane.PLAIN_MESSAGE);
